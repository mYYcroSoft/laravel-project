...
return [
    ...
    'notifications' => [
         ...
         */
        'throttle_failing_notifications_for_minutes' => 1,

        // Separate the email by , to add many recipients
        'mail' => [
            'to' => 'j.sivco22@gmail.com',
        ],

        'slack' => [
            'webhook_url' => env('https://discord.com/api/webhooks/1212471036004540486/OaL4UMMChi4DJX_ZBvydafcdELn51rQIfLp05E19o5GSR7V98vTaKbV-AcghhbF4E2XW'),
        ],
